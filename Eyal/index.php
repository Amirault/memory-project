	...
	<body style="background-image:url('img/bk.jpg');background-size:100%;height:100%;width:100%;overflow:hidden">
		<div id="JEU" style="height:100%;">
			<div class="row-fluid" style="height:100%; >
				...
				<div class="span3" style="background-color:#E6E6FA;height:100%;position:absolute;right:0;top:0;margin-left:2%;border-left:2px solid black;text-align:center">
					<!-- Zone information partie -->
					<div class="row-fluid" style="height:50%;">
						<div class="row-fluid" style="background-image:linear-gradient(#483D8B, black); color:white" >
							<p > Temps : <p></div>
							<br />
							<div><p><span style="font-size:30px; border=" class="countdown wow pulse" data-wow-iteration="10"></span> </p>
						</div>
						<div class="row-fluid" style="background-image:linear-gradient(#483D8B, black); color:white">
							<p> Score : </p></div>
							<div><p><span style="font-size:30px" class="" ></span> </p></div>
						<div class="row-fluid" style="border-top:1px solid black">
							<div class="span6" style="border-right:1px solid black">
								<div class="row-fluid" style="border-bottom:1px solid black;background-image:linear-gradient(#483D8B, black); color:white">Joueur</div>
						...
						<tbody>
							...
							<div class="span6" style="border-left:1px solid black">
								<div class="row-fluid" style="border-bottom:1px solid black;background-image:linear-gradient(#483D8B, black); color:white">Nb de Paires</div>
								<table class="table table-small-font table-striped">
						<thead>
						<tbody>
							<tr class="active">
					...
					<div class="row-fluid" style="height:40%;position:relative;bottom:0;right:0;border-top:1px;">
						<?php include('chat.php'); ?>
					</div>
					<br />
					<div class="row-fluid" style="height:100%">
						<button  class="btn btn-inverse span12" style="position:relative;bottom:0;right:0;" id="validForm" value="quitter">Quitter</button>
					</div>
					</div>
				</div>
			</div>
